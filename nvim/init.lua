-- neovim config based on kickstart.nvim and modified
...
-- Open neotree when neovim is opened without arguments (a file)
...
require("lazy").setup({
	...
	-- Configure color theme (scheme)
	-- Install by running `:Lazy sync`
	{
		"rose-pine/neovim",
		name = "rose-pine",
		priority = 1000,
